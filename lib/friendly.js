 ...
 * @returns {string}
 */
export function getFriendlyTime(timestamp, type = 'common') {
    let date;
...
export function getBeforeTimestamp(beforeSeconds) {
    return Math.ceil(Date.now() / 1000) - beforeSeconds;
}

export function leftPadString(str, len, fill) {
...
export function parseISOTimeToString(isoTime) {
